...
// (TOPIK II Writing feedback + the sequenced mock) stay locked until they click
// the link we email.
      ...
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-3 text-sm">
        <p className="text-almi-ink">
          ...
          <span className="text-almi-text">
            TOPIK II Writing feedback and the mock stay locked until you click the link we sent to {email}.
          </span>
        </p>
